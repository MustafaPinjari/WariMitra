...
# If DB_ENGINE is specified as postgresql, or if DB_NAME is set in .env, use PostgreSQL
if DB_ENGINE.lower() in ('postgresql', 'postgres', 'django.db.backends.postgresql') or (not DB_ENGINE and config('DB_NAME', default='')):
    DATABASES = {
        'default': {
